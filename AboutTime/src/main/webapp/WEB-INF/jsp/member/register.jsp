				...
				<form method="POST">
					<div class="form-group" id="uid-group">
						<label class="control-label" for="uid">아이디</label> <input
							...
							<span id="help-uid" class="help-block"></span>
					</div>
					<div class="form-group" id="uname-group">
						<label class="control-label" for="uname">별명</label> <input type="text" id="uname"
							class="form-control"
							aria-describedby="help-uname">
							<span id="help-uname" class="help-block"></span>
					</div>
					<div class="row">
						<div class="form-group col-md-6" id="upw-group">
							<label for="upw">비밀번호</label> <input type="password" id="upw"
								class="form-control" aria-describedby="help-upw">
								<span id="help-upw" class="help-block"></span>
						</div>
